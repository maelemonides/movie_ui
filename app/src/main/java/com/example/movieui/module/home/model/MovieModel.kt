...
/*data class MovieModel(
    ...
    var isFavorite: Boolean = false // Set to false by default
)*/
...
val upcoming = listOf(
    MovieModel(
        id = "4",  // Unique ID for upcoming movie 1
    ...
    MovieModel(
        id = "5",  // Unique ID for upcoming movie 2
        title = "Nope",
    ...
    MovieModel(
        id = "6",  // Unique ID for upcoming movie 3
